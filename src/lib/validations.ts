...
export const createEventSchema = z.object({
  ...
  shortDescription: z.string().min(10, "La description doit contenir au moins 10 caractères").max(500),
  ...
  location: z.string().min(3, "Le lieu doit contenir au moins 3 caractères").max(300),
})
